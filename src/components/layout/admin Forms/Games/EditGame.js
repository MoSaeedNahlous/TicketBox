...
const EditGame = () => {
  ...
  useEffect(() => {
    ...
    if (current !== null) {
      setState({
        ...
        host: current.gameTeams.host,
        guest: current.gameTeams.guest,
        stadium: current.stadium.stadiumId,
        gameIdentifier: current.gameIdentifier,
      });
  ...
  const onSubmitHandler = (e) => {
    ...
    if (
      current.gameTeams.host !== state.host ||
      current.gameTeams.guest !== state.guest
    ) {
      if (state.id === null) {
    ...
    <div className='container'>
      <form id='form1' onSubmit={onSubmitHandler}>
        ...
        <div className='form-group'>
          ...
          <h6>
            {state.id === ''
              ? 'Select a game from the table by pressing pencil button from the wanted game!'
              : state.id}
          </h6>
          <br />
        ...
        <div className='form-group'>
          ...
          <input
            type='text'
            className='form-control'
            placeholder='day/month/year hour:minutes'
            onChange={onChangeHandler}
