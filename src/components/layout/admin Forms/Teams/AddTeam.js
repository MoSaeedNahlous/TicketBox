...
const AddTeam = () => {
  ...
  const [team, setTeam] = useState({'name':'','country':'','city':'','image':''})
  ...
  const fileSelectedHandler = (e) =>{
   ...
   img.onload=function(){
    ...
    <div className="form-group">
      ...
      <input type="text" className="form-control" name='name' placeholder="Team Name" value={team.name} onChange={onChangeHandler} required/>
    ...
    <div className="form-group">
      <label >Country</label>
      <select required className="form-control" value={team.country} name='country' onChange={onChangeHandler} >
      <option value="" hidden> 
          Select Country 
      </option> 
    ...
    <div className="form-group">
      <label >City</label>
      <select required className="form-control" value={team.city} name='city' onChange={onChangeHandler} >
      <option value="" hidden> 
          Select City 
      </option> 
  ...
  <button type="submit" className="btn btn-primary" style={{float:'right'}}>Add Team</button>
</form>
        </div>
    )
    }
