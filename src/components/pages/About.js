...
const About = () => {
    return (
        ...
        <br />
        <div className="row">
            <div className="col-sm-4 wite" style={{textAlign:"center"}}><h3>title</h3><p>Lorem ipsum dolor sit amet consecteexercitationem, hic quas ad molestiae minus? hic quas ad molestiae minus? hic quas ad molestiae minus?</p></div>
            <div className="col-sm-4 wite" style={{textAlign:"center"}}><h3>title</h3><p>Lorem ipsum dolor sit amet consecteexercitationem, hic quas ad molestiae minus? hic quas ad molestiae minus? hic quas ad molestiae minus?</p></div>
            <div className="col-sm-4 wite" style={{textAlign:"center"}}><h3>title</h3><p>Lorem ipsum dolor sit amet consecteexercitationem, hic quas ad molestiae minus? hic quas ad molestiae minus? hic quas ad molestiae minus?</p></div>
